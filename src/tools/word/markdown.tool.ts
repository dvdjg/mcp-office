...
export const exportSchema = z.object({
    ...
    /** If true (default), removes unnecessary backslash escapes from Markdown generated by the library path (Mammoth). */
    cleanMarkdownEscapes: z.boolean().optional().default(true).describe("If true (default), removes unnecessary backslash escapes from Markdown generated by the library path (Mammoth)."),
});
...
export async function exportToMarkdown(params: ToolRequestParams, context?: FastMCPContext<undefined>): Promise<ApiResponse<{ outputPath: string }>> {
    ...
    const {
        ...
        useComInterop,
        cleanMarkdownEscapes // Added new parameter
    } = validatedParams;
