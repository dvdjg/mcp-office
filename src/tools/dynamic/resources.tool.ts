...
export const dynamicResourcesTool: McpResource[] = [{
  ...
  description: 'Gestiona recursos dinámicos generados por el usuario (documentos, imágenes, etc.) almacenados en /dynamic_storage. Permite listar, leer, escribir, eliminar, obtener metadatos y buscar recursos.',
